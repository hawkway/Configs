...
local tags = {
  ...
  names = { "一", "二", "三", "四", "五", "六", "七", "八" },
    ...
    layout = {
      layouts[1],  -- 1:firefox (max size)
      layouts[1],  -- 2:weechat/xchat/pidgin (tiled)
      layouts[1],  -- 3:logs/bots/shells (tiled)
      layouts[1],  -- 4:media playing (tiled)
      layouts[1],  -- 5:media editing (floating)
      layouts[1],  -- 6:projects/development (tiled)
...
globalkeys = awful.util.table.join(
  ...
  keydoc.group('Client manipulation'),
   ...
   awful.key({ usr.modkey }, 'u' , function ()
